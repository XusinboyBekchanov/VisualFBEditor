...
Type Object_Com_
	...
	#else
		Declare Function Call cdecl (ByVal MethodName As LPOLESTR, TypeChars As String = "", ...) As Object_Com_
		Declare Function  Get cdecl (ByVal MethodName As LPOLESTR, TypeChars As String = "", ...) As Object_Com_
	...
	#endif
	Declare Function  vbV() As Object_Com_
...
Function Object_Com_.vbV() As Object_Com_
	Return This
End Function
Constructor Object_Com_()
	'we dont't do anything here in the base constructor currently
End Constructor
Destructor Object_Com_()
	'MsgBox "Destructor of: " & TypeName
	If V.vt Then VariantClear @V
End Destructor
Sub Object_Com_.Clear() 'usable on the Outside, e.g. to dereference an Object "early"
	If V.vt Then VariantClear @V: VariantInit @V
End Sub

Function Object_Com_.VarType() As vbVarType
	Return V.vt
End Function
Function Object_Com_.TypeName() As String
	Dim T As String
	...
	Return T
End Function
Function Object_Com_.IsEmpty() As Boolean
	Return V.vt = vbEmpty
End Function
Function Object_Com_.IsArray() As Boolean
	If V.vt And vbArray Then Return True
End Function
Function Object_Com_.IsObject() As Boolean
	Return V.vt = vbObject
End Function


Constructor Object_Com_(ByVal RHS As Boolean)
	This = RHS
End Constructor
Operator Object_Com_.Let(ByVal RHS As Boolean)
	If V.vt <> vbBoolean  And V.vt <> vbEmpty Then VariantClear @V
	V.vt =  vbBoolean: V.boolVal = CShort(RHS)
End Operator
Operator Object_Com_.Cast() As Boolean
...
Constructor Object_Com_(ByVal RHS As UByte)
	This = RHS
End Constructor
Operator Object_Com_.Let(ByVal RHS As UByte)
	If V.vt <> vbByte  And V.vt <> vbEmpty Then VariantClear @V
	V.vt =  vbByte: V.bVal = RHS
End Operator
Operator Object_Com_.Cast() As UByte
	If V.vt = vbByte Then
		Return V.bVal
	Else
		Dim VV As tagVARIANT
...
Constructor Object_Com_(ByVal RHS As Short)
	This = RHS
End Constructor
Operator Object_Com_.Let(ByVal RHS As Short)
	If V.vt <> vbInteger  And V.vt <> vbEmpty Then VariantClear @V
	V.vt =  vbInteger: V.iVal = RHS
End Operator
Operator Object_Com_.Cast() As Short
...
Constructor Object_Com_(ByVal RHS As Long)
	This = RHS
End Constructor
Operator Object_Com_.Let(ByVal RHS As Long)
	If V.VT <> vbLong  And V.VT <> vbEmpty Then VariantClear @V
	V.VT =  vbLong: V.lVal = RHS
End Operator
Operator Object_Com_.Cast() As Long
	If V.VT = vbLong Then
		Return V.lVal
	Else
		Dim VV As tagVariant
...
Constructor Object_Com_(ByVal RHS As LongInt)
	This = RHS
End Constructor
Operator Object_Com_.Let(ByVal RHS As LongInt)
	If V.VT <> vbCurrency  And V.VT <> vbEmpty Then VariantClear @V
	V.VT =  vbCurrency: V.llVal = RHS * 10000
End Operator
Operator Object_Com_.Cast() As LongInt
...
Constructor Object_Com_(ByVal RHS As Single)
	This = RHS
End Constructor
Operator Object_Com_.Let(ByVal RHS As Single)
	If V.VT <> vbSingle  And V.VT <> vbEmpty Then VariantClear @V
	V.VT =  vbSingle: V.fltVal = RHS
End Operator
Operator Object_Com_.Cast() As Single
...
Constructor Object_Com_(ByVal RHS As Double)
	This = RHS
End Constructor
Operator Object_Com_.Let(ByVal RHS As Double)
	If V.VT <> vbDouble  And V.VT <> vbEmpty Then VariantClear @V
	V.VT =  vbDouble: V.dblVal = RHS
End Operator
Operator Object_Com_.Cast() As Double
...
Constructor Object_Com_(RHS As String)
	This = RHS
End Constructor
Operator Object_Com_.Let(RHS As String)
	If V.VT Then VariantClear @V
	V.VT = vbString: V.bstrVal = S2BSTR(RHS)
End Operator
Operator Object_Com_.Cast() As String
...
Constructor Object_Com_(ByVal RHS As Const WString Ptr)
	This = RHS
End Constructor
Operator Object_Com_.Let(ByVal RHS As Const WString Ptr)
	If V.VT Then VariantClear @V
	V.VT = vbString: V.bstrVal = W2BSTR(RHS)
End Operator
Operator Object_Com_.Cast() As WString Ptr
	If V.VT = vbString Then
...
Constructor Object_Com_(RHS As tagVariant)
...
End Constructor
Operator Object_Com_.Let(RHS As tagVariant)
	If @This = @RHS Then Exit Operator
	If V.VT Then VariantClear @V
	VariantCopy @V, @RHS
End Operator
Operator Object_Com_.Cast() As tagVariant
...
Constructor Object_Com_(RHS As Object_Com_)
	If @This = @RHS Then Exit Constructor
	If V.VT Then VariantClear @V
	VariantCopy @V, @RHS.V
End Constructor
Operator Object_Com_.Let(RHS As Object_Com_)
	If @This = @RHS Then Exit Operator
	If V.VT Then VariantClear @V
	VariantCopy @V, @RHS.V
End Operator
...
#ifdef __FB_64BIT__
	Function Object_Com_.Call cdecl (ByVal MethodName As LPOLESTR, TypeChars As String = "", ByVal Arg0 As Any Ptr = 0, ByVal Arg1 As Any Ptr = 0, ByVal Arg2 As Any Ptr = 0, ByVal Arg3 As Any Ptr = 0, ByVal Arg4 As Any Ptr = 0, ByVal Arg5 As Any Ptr = 0, ByVal Arg6 As Any Ptr = 0, ByVal Arg7 As Any Ptr = 0, ByVal Arg8 As Any Ptr = 0, ByVal Arg9 As Any Ptr = 0, ByVal Arg10 As Any Ptr = 0, ByVal Arg11 As Any Ptr = 0, ByVal Arg12 As Any Ptr = 0, ByVal Arg13 As Any Ptr = 0, ByVal Arg14 As Any Ptr = 0, ByVal Arg15 As Any Ptr = 0, ByVal Arg16 As Any Ptr = 0, ByVal Arg17 As Any Ptr = 0, ByVal Arg18 As Any Ptr = 0, ByVal Arg19 As Any Ptr = 0, ByVal Arg20 As Any Ptr = 0, ByVal Arg21 As Any Ptr = 0, ByVal Arg22 As Any Ptr = 0, ByVal Arg23 As Any Ptr = 0, ByVal Arg24 As Any Ptr = 0, ByVal Arg25 As Any Ptr = 0, ByVal Arg26 As Any Ptr = 0, ByVal Arg27 As Any Ptr = 0, ByVal Arg28 As Any Ptr = 0, ByVal Arg29 As Any Ptr = 0, ByVal Arg30 As Any Ptr = 0, ByVal Arg31 As Any Ptr = 0) As Object_Com_
		...
		Function = tv
	End Function
	Function Object_Com_.Get cdecl (ByVal MethodName As LPOLESTR, TypeChars As String = "", ByVal Arg0 As Any Ptr = 0, ByVal Arg1 As Any Ptr = 0, ByVal Arg2 As Any Ptr = 0, ByVal Arg3 As Any Ptr = 0, ByVal Arg4 As Any Ptr = 0, ByVal Arg5 As Any Ptr = 0, ByVal Arg6 As Any Ptr = 0, ByVal Arg7 As Any Ptr = 0, ByVal Arg8 As Any Ptr = 0, ByVal Arg9 As Any Ptr = 0, ByVal Arg10 As Any Ptr = 0, ByVal Arg11 As Any Ptr = 0, ByVal Arg12 As Any Ptr = 0, ByVal Arg13 As Any Ptr = 0, ByVal Arg14 As Any Ptr = 0, ByVal Arg15 As Any Ptr = 0, ByVal Arg16 As Any Ptr = 0, ByVal Arg17 As Any Ptr = 0, ByVal Arg18 As Any Ptr = 0, ByVal Arg19 As Any Ptr = 0, ByVal Arg20 As Any Ptr = 0, ByVal Arg21 As Any Ptr = 0, ByVal Arg22 As Any Ptr = 0, ByVal Arg23 As Any Ptr = 0, ByVal Arg24 As Any Ptr = 0, ByVal Arg25 As Any Ptr = 0, ByVal Arg26 As Any Ptr = 0, ByVal Arg27 As Any Ptr = 0, ByVal Arg28 As Any Ptr = 0, ByVal Arg29 As Any Ptr = 0, ByVal Arg30 As Any Ptr = 0, ByVal Arg31 As Any Ptr = 0) As Object_Com_
	...
	End Function
	Sub Object_Com_.Put cdecl (ByVal MethodName As LPOLESTR, TypeChars As String = "", ByVal Arg0 As Any Ptr = 0, ByVal Arg1 As Any Ptr = 0, ByVal Arg2 As Any Ptr = 0, ByVal Arg3 As Any Ptr = 0, ByVal Arg4 As Any Ptr = 0, ByVal Arg5 As Any Ptr = 0, ByVal Arg6 As Any Ptr = 0, ByVal Arg7 As Any Ptr = 0, ByVal Arg8 As Any Ptr = 0, ByVal Arg9 As Any Ptr = 0, ByVal Arg10 As Any Ptr = 0, ByVal Arg11 As Any Ptr = 0, ByVal Arg12 As Any Ptr = 0, ByVal Arg13 As Any Ptr = 0, ByVal Arg14 As Any Ptr = 0, ByVal Arg15 As Any Ptr = 0, ByVal Arg16 As Any Ptr = 0, ByVal Arg17 As Any Ptr = 0, ByVal Arg18 As Any Ptr = 0, ByVal Arg19 As Any Ptr = 0, ByVal Arg20 As Any Ptr = 0, ByVal Arg21 As Any Ptr = 0, ByVal Arg22 As Any Ptr = 0, ByVal Arg23 As Any Ptr = 0, ByVal Arg24 As Any Ptr = 0, ByVal Arg25 As Any Ptr = 0, ByVal Arg26 As Any Ptr = 0, ByVal Arg27 As Any Ptr = 0, ByVal Arg28 As Any Ptr = 0, ByVal Arg29 As Any Ptr = 0, ByVal Arg30 As Any Ptr = 0, ByVal Arg31 As Any Ptr = 0)
	...
	End Sub
	'Sub Object_Com_.Set cdecl (ByVal MethodName As LPOLESTR, TypeChars As String = "", ByVal Arg0 As Any Ptr = 0, ByVal Arg1 As Any Ptr = 0, ByVal Arg2 As Any Ptr = 0, ByVal Arg3 As Any Ptr = 0, ByVal Arg4 As Any Ptr = 0, ByVal Arg5 As Any Ptr = 0, ByVal Arg6 As Any Ptr = 0, ByVal Arg7 As Any Ptr = 0, ByVal Arg8 As Any Ptr = 0, ByVal Arg9 As Any Ptr = 0, ByVal Arg10 As Any Ptr = 0, ByVal Arg11 As Any Ptr = 0, ByVal Arg12 As Any Ptr = 0, ByVal Arg13 As Any Ptr = 0, ByVal Arg14 As Any Ptr = 0, ByVal Arg15 As Any Ptr = 0, ByVal Arg16 As Any Ptr = 0, ByVal Arg17 As Any Ptr = 0, ByVal Arg18 As Any Ptr = 0, ByVal Arg19 As Any Ptr = 0, ByVal Arg20 As Any Ptr = 0, ByVal Arg21 As Any Ptr = 0, ByVal Arg22 As Any Ptr = 0, ByVal Arg23 As Any Ptr = 0, ByVal Arg24 As Any Ptr = 0, ByVal Arg25 As Any Ptr = 0, ByVal Arg26 As Any Ptr = 0, ByVal Arg27 As Any Ptr = 0, ByVal Arg28 As Any Ptr = 0, ByVal Arg29 As Any Ptr = 0, ByVal Arg30 As Any Ptr = 0, ByVal Arg31 As Any Ptr = 0)
	...
	'End Sub
#else
	Function Object_Com_.Call cdecl (ByVal MethodName As LPOLESTR, TypeChars As String = "", ...) As Object_Com_
		Dim tv As tagVARIANT
		tv = CallByName(V, MethodName, DISPATCH_METHOD Or DISPATCH_PROPERTYGET, TypeChars, va_first)
		Function = tv
	End Function
	Function Object_Com_.Get cdecl (ByVal MethodName As LPOLESTR, TypeChars As String = "", ...) As Object_Com_
		Return CallByName(V, MethodName, DISPATCH_METHOD Or DISPATCH_PROPERTYGET, TypeChars, va_first)
	End Function
	Sub Object_Com_.Put cdecl (ByVal MethodName As LPOLESTR, TypeChars As String = "", ...)
		CallByName(V, MethodName, DISPATCH_PROPERTYPUT, TypeChars, va_first)
	End Sub
	'Sub Object_Com_.Set cdecl (ByVal MethodName As LPOLESTR, TypeChars As String = "", ...)
