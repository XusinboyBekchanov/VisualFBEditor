...
Constructor frmGridDataTest  
  ...
  ' Form Property
   ...
   MSHFGridCont.Columns.Add "NO ", 0,35,cfCenter, False,DT_Numeric,False,DT_Numeric,,ssSortAscending
   MSHFGridCont.Columns.Add "Property" +WChr(13,10)+"1TH", 0, 100,cfLeft, True,DT_Numeric,False,CT_TextBox,,ssSortAscending
   MSHFGridCont.Columns.Add "Property" +WChr(13,10)+"2nd", 0, 100,cfRight, True,DT_LinkLabel,False,CT_LinkLabel,,ssSortAscending
   MSHFGridCont.Columns.Add "Property" +WChr(13,10)+"3RD", 0, 100,cfCenter, True,DT_String,False,CT_Button,,ssSortAscending
   MSHFGridCont.Columns.Add "Value",0, 70,cfCenter, True,DT_String,False,CT_ComboBoxEdit,*ComboEditItem,ssSortAscending
   MSHFGridCont.Columns.Add "GridData"+WChr(13,10)+"5TH",0, 100,cfCenter, True,DT_String,False,CT_CheckBox,,ssSortAscending
   MSHFGridCont.Columns.Add "GridData"+WChr(13,10)+ "6TH",0, 100,cfCenter, True,DT_ProgressBar,False,CT_ProgressBar,,ssSortAscending
   MSHFGridCont.Columns.Add "GridData"+WChr(13,10)+ "7TH",0, 100,cfCenter, True,DT_Date,False,CT_DateTimePicker,,ssSortAscending
   MSHFGridCont.Columns.Add "GridData"+WChr(13,10)+ "8TH",0, 100,cfCenter, True,DT_String,False,CT_TextBox,,ssSortAscending
...
'	MSHFGridCont.Parent = @Frame_Sql
  ...
  Picture1.SetBounds 140, 420, 400, 400              
...
Private Sub frmGridDataTest.Form_Show(ByRef Sender As Control)
   ...
   fGridDataTest.MSHFGrid.Columns.Add "NO ", 0,35,cfCenter, False,DT_String,False,DT_String,,ssSortAscending
   fGridDataTest.MSHFGrid.Columns.Add "Table" +WChr(13,10)+"Name", 0, 130,cfLeft, True,DT_String,False,CT_TextBox,,ssSortAscending
