' MDIScintillaControl MDIMain.frm
...
#include once "../MDIScintilla/frmFindReplace.frm"
...
Private Sub MDIMainType.Form_Create(ByRef Sender As Control)
	...
	CodePageMnu(06) = @mnuCodePage06
		...
		WLet(mCaption, "VFBE MDI ScintillaControl64" & fbcVer)
	#else
		'...instructions for other OSes
		WLet(mCaption, "VFBE MDI ScintillaControl32" & fbcVer)
	#endif
	Caption = *mCaption
...
Private Sub MDIMainType.StatusBar1_PanelClick(ByRef Sender As StatusBar, ByRef stPanel As StatusPanel, MouseButton As Integer, x As Integer, y As Integer)
	Debug.Print "StatusBar1_PanelClick " & stPanel.Name
...
Private Sub MDIMainType.mnuHelp_Click(ByRef Sender As MenuItem)
	Select Case Sender.Name
	Case "mnuHelpAbout"
		MsgBox(!"Visual FB Editor\r\n\r\nMDI ScintillaControl Example\r\nBy Cm Wang\r\n2024", "MDI ScintillaControl Example")
	Case Else
		MsgBox Sender.Name & !"\r\nThis function is under construction", "Edit"
	End Select
End Sub
