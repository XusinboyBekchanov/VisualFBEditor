...
cd ..
cd src
../Compilers/FreeBASIC-1.09.0-linux-x86_64/bin/fbc "VisualFBEditor.bas" -x "../VisualFBEditor64_gtk3" -i "../Controls/MyFbFramework" -d __USE_GTK3__ -v -g
cd ..
cd Controls/MyFbFramework/mff
../../../Compilers/FreeBASIC-1.09.0-linux-x86_64/bin/fbc -b "mff.bi" -dll -x "../libmff64_gtk3.so" -d __USE_GTK3__ -v -g
cd ..
cd ..
cd ..
