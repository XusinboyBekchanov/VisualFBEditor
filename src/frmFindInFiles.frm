...
Sub frmFindInFiles.Find(ByRef lvSearchResult As ListView Ptr, ByRef Path As WString = "", ByRef tSearch As WString = "")
	...
	While f <> ""
		...
		ElseIf EndsWith(LCase(f), ".bas") OrElse EndsWith(LCase(f), ".bi") OrElse EndsWith(LCase(f), ".rc") _
			OrElse EndsWith(LCase(f), ".inc") OrElse EndsWith(LCase(f), ".frm") OrElse EndsWith(LCase(f), ".rpt") OrElse EndsWith(LCase(f), ".ini") OrElse EndsWith(LCase(f), ".md") OrElse EndsWith(LCase(f), ".htm")  OrElse EndsWith(LCase(f), ".html") _ _
...
Private Sub frmFindInFiles.ReplaceInFile(ByRef Path As WString ="", ByRef tSearch As WString="", ByRef tReplace As WString="")
	...
	While f <> ""
		...
		ElseIf EndsWith(LCase(f), ".bas") OrElse EndsWith(LCase(f), ".bi") OrElse EndsWith(LCase(f), ".rc") _
			OrElse EndsWith(LCase(f), ".inc") OrElse EndsWith(LCase(f), ".frm") OrElse EndsWith(LCase(f), ".rpt") OrElse EndsWith(LCase(f), ".ini") OrElse EndsWith(LCase(f), ".md") OrElse EndsWith(LCase(f), ".htm")  OrElse EndsWith(LCase(f), ".html") _
			OrElse EndsWith(LCase(f), ".txt") OrElse EndsWith(LCase(f), ".log") OrElse EndsWith(LCase(f), ".lng") _
			OrElse EndsWith(LCase(f), ".vfp") OrElse EndsWith(LCase(f), ".vfs") OrElse EndsWith(LCase(f), ".xml") _
			OrElse EndsWith(LCase(f), ".c") OrElse EndsWith(LCase(f), ".cxx") OrElse EndsWith(LCase(f), ".h") OrElse EndsWith(LCase(f), ".idl") OrElse EndsWith(LCase(f), ".cpp") OrElse EndsWith(LCase(f), ".java") Then
