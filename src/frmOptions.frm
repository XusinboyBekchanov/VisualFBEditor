...
Private Sub frmOptions.cboTheme_Change(ByRef Sender As Control)
	With fOptions
		...
		.Colors(19, 0) = piniTheme->ReadInteger("Colors", "LocalVariablesForeground", .Colors(8, 0))
		.Colors(19, 1) = piniTheme->ReadInteger("Colors", "LocalVariablesBackground", .Colors(8, 1))
		.Colors(19, 2) = piniTheme->ReadInteger("Colors", "LocalVariablesFrame", .Colors(8, 2))
		.Colors(19, 4) = piniTheme->ReadInteger("FontStyles", "LocalVariablesBold", 0)
		.Colors(19, 5) = piniTheme->ReadInteger("FontStyles", "LocalVariablesItalic", 0)
		.Colors(19, 6) = piniTheme->ReadInteger("FontStyles", "LocalVariablesUnderline", 0)
		
		.Colors(20, 0) = piniTheme->ReadInteger("Colors", "MacrosForeground", .Colors(8, 0))
		.Colors(20, 1) = piniTheme->ReadInteger("Colors", "MacrosBackground", .Colors(8, 1))
		.Colors(20, 2) = piniTheme->ReadInteger("Colors", "MacrosFrame", .Colors(8, 2))
		.Colors(20, 4) = piniTheme->ReadInteger("FontStyles", "MacrosBold", 0)
		.Colors(20, 5) = piniTheme->ReadInteger("FontStyles", "MacrosItalic", 0)
		.Colors(20, 6) = piniTheme->ReadInteger("FontStyles", "MacrosUnderline", 0)
		
		.Colors(21, 0) = piniTheme->ReadInteger("Colors", "GlobalNamespacesForeground", .Colors(8, 0))
		.Colors(21, 1) = piniTheme->ReadInteger("Colors", "GlobalNamespacesBackground", .Colors(8, 1))
		.Colors(21, 2) = piniTheme->ReadInteger("Colors", "GlobalNamespacesFrame", .Colors(8, 2))
		.Colors(21, 4) = piniTheme->ReadInteger("FontStyles", "GlobalNamespacesBold", 0)
		.Colors(21, 5) = piniTheme->ReadInteger("FontStyles", "GlobalNamespacesItalic", 0)
		.Colors(21, 6) = piniTheme->ReadInteger("FontStyles", "GlobalNamespacesUnderline", 0)
		
		.Colors(22, 0) = piniTheme->ReadInteger("Colors", "PropertiesForeground", .Colors(8, 0))
		.Colors(22, 1) = piniTheme->ReadInteger("Colors", "PropertiesBackground", .Colors(8, 1))
		.Colors(22, 2) = piniTheme->ReadInteger("Colors", "PropertiesFrame", .Colors(8, 2))
		.Colors(22, 4) = piniTheme->ReadInteger("FontStyles", "PropertiesBold", 0)
		.Colors(22, 5) = piniTheme->ReadInteger("FontStyles", "PropertiesItalic", 0)
		.Colors(22, 6) = piniTheme->ReadInteger("FontStyles", "PropertiesUnderline", 0)
		
		.Colors(23, 0) = piniTheme->ReadInteger("Colors", "SharedVariablesForeground", .Colors(8, 0))
		.Colors(23, 1) = piniTheme->ReadInteger("Colors", "SharedVariablesBackground", .Colors(8, 1))
		.Colors(23, 2) = piniTheme->ReadInteger("Colors", "SharedVariablesFrame", .Colors(8, 2))
		.Colors(23, 4) = piniTheme->ReadInteger("FontStyles", "SharedVariablesBold", 0)
		.Colors(23, 5) = piniTheme->ReadInteger("FontStyles", "SharedVariablesItalic", 0)
		.Colors(23, 6) = piniTheme->ReadInteger("FontStyles", "SharedVariablesUnderline", 0)
		
		.Colors(24, 0) = piniTheme->ReadInteger("Colors", "SubsForeground", .Colors(8, 0))
		.Colors(24, 1) = piniTheme->ReadInteger("Colors", "SubsBackground", .Colors(8, 1))
		.Colors(24, 2) = piniTheme->ReadInteger("Colors", "SubsFrame", .Colors(8, 2))
		.Colors(24, 4) = piniTheme->ReadInteger("FontStyles", "SubsBold", 0)
		.Colors(24, 5) = piniTheme->ReadInteger("FontStyles", "SubsItalic", 0)
		.Colors(24, 6) = piniTheme->ReadInteger("FontStyles", "SubsUnderline", 0)
		
		.Colors(25, 0) = piniTheme->ReadInteger("Colors", "GlobalTypesForeground", .Colors(8, 0))
		.Colors(25, 1) = piniTheme->ReadInteger("Colors", "GlobalTypesBackground", .Colors(8, 1))
		.Colors(25, 2) = piniTheme->ReadInteger("Colors", "GlobalTypesFrame", .Colors(8, 2))
		.Colors(25, 4) = piniTheme->ReadInteger("FontStyles", "GlobalTypesBold", 0)
		.Colors(25, 5) = piniTheme->ReadInteger("FontStyles", "GlobalTypesItalic", 0)
		.Colors(25, 6) = piniTheme->ReadInteger("FontStyles", "GlobalTypesUnderline", 0)
		
		.Colors(26, 0) = piniTheme->ReadInteger("Colors", "IndicatorLinesForeground", -1)
		Dim As Integer k
		For k = 0 To UBound(Keywords)
			.Colors(27 + k, 0) = piniTheme->ReadInteger("Colors", Replace(KeywordLists.Item(k), " ", "") & "Foreground", piniTheme->ReadInteger("Colors", "KeywordsForeground", -1))
			.Colors(27 + k, 1) = piniTheme->ReadInteger("Colors", Replace(KeywordLists.Item(k), " ", "") & "Background", piniTheme->ReadInteger("Colors", "KeywordsBackground", -1))
			.Colors(27 + k, 2) = piniTheme->ReadInteger("Colors", Replace(KeywordLists.Item(k), " ", "") & "Frame", piniTheme->ReadInteger("Colors", "KeywordsFrame", -1))
			.Colors(27 + k, 4) = piniTheme->ReadInteger("FontStyles", Replace(KeywordLists.Item(k), " ", "") & "Bold", piniTheme->ReadInteger("Colors", "KeywordsBold", 0))
			.Colors(27 + k, 5) = piniTheme->ReadInteger("FontStyles", Replace(KeywordLists.Item(k), " ", "") & "Italic", piniTheme->ReadInteger("Colors", "KeywordsItalic", 0))
			.Colors(27 + k, 6) = piniTheme->ReadInteger("FontStyles", Replace(KeywordLists.Item(k), " ", "") & "Underline", piniTheme->ReadInteger("Colors", "KeywordsUnderline", 0))
		Next k
		k = UBound(Keywords)
		.Colors(28 + k, 0) = piniTheme->ReadInteger("Colors", "LineNumbersForeground", -1)
		.Colors(28 + k, 1) = piniTheme->ReadInteger("Colors", "LineNumbersBackground", -1)
		.Colors(28 + k, 2) = piniTheme->ReadInteger("Colors", "LineNumbersFrame", -1)
		.Colors(28 + k, 4) = piniTheme->ReadInteger("FontStyles", "LineNumbersBold", 0)
		.Colors(28 + k, 5) = piniTheme->ReadInteger("FontStyles", "LineNumbersItalic", 0)
		.Colors(28 + k, 6) = piniTheme->ReadInteger("FontStyles", "LineNumbersUnderline", 0)
		.Colors(30 + k, 0) = piniTheme->ReadInteger("Colors", "NumbersForeground", -1)
		.Colors(30 + k, 1) = piniTheme->ReadInteger("Colors", "NumbersBackground", -1)
		.Colors(30 + k, 2) = piniTheme->ReadInteger("Colors", "NumbersFrame", -1)
		.Colors(30 + k, 4) = piniTheme->ReadInteger("FontStyles", "NumbersBold", 0)
		.Colors(30 + k, 5) = piniTheme->ReadInteger("FontStyles", "NumbersItalic", 0)
		.Colors(30 + k, 6) = piniTheme->ReadInteger("FontStyles", "NumbersUnderline", 0)
		.Colors(31 + k, 0) = piniTheme->ReadInteger("Colors", "RealNumbersForeground", -1)
		.Colors(31 + k, 1) = piniTheme->ReadInteger("Colors", "RealNumbersBackground", -1)
		.Colors(31 + k, 2) = piniTheme->ReadInteger("Colors", "RealNumbersFrame", -1)
		.Colors(31 + k, 4) = piniTheme->ReadInteger("FontStyles", "RealNumbersBold", 0)
		.Colors(31 + k, 5) = piniTheme->ReadInteger("FontStyles", "RealNumbersItalic", 0)
		.Colors(31 + k, 6) = piniTheme->ReadInteger("FontStyles", "RealNumbersUnderline", 0)
		.Colors(32 + k, 0) = piniTheme->ReadInteger("Colors", "OperatorsForeground", -1)
		.Colors(32 + k, 1) = piniTheme->ReadInteger("Colors", "OperatorsBackground", -1)
		.Colors(32 + k, 2) = piniTheme->ReadInteger("Colors", "OperatorsFrame", -1)
		.Colors(32 + k, 4) = piniTheme->ReadInteger("FontStyles", "OperatorsBold", 0)
		.Colors(32 + k, 5) = piniTheme->ReadInteger("FontStyles", "OperatorsItalic", 0)
		.Colors(32 + k, 6) = piniTheme->ReadInteger("FontStyles", "OperatorsUnderline", 0)
		.Colors(33 + k, 0) = piniTheme->ReadInteger("Colors", "SelectionForeground", -1)
		.Colors(33 + k, 1) = piniTheme->ReadInteger("Colors", "SelectionBackground", -1)
		.Colors(33 + k, 2) = piniTheme->ReadInteger("Colors", "SelectionFrame", -1)
		.Colors(34 + k, 0) = piniTheme->ReadInteger("Colors", "SpaceIdentifiersForeground", -1)
		.Colors(35 + k, 0) = piniTheme->ReadInteger("Colors", "StringsForeground", -1)
		.Colors(35 + k, 1) = piniTheme->ReadInteger("Colors", "StringsBackground", -1)
		.Colors(35 + k, 2) = piniTheme->ReadInteger("Colors", "StringsFrame", -1)
		.Colors(35 + k, 4) = piniTheme->ReadInteger("FontStyles", "StringsBold", 0)
		.Colors(35 + k, 5) = piniTheme->ReadInteger("FontStyles", "StringsItalic", 0)
		.Colors(35 + k, 6) = piniTheme->ReadInteger("FontStyles", "StringsUnderline", 0)
		.lstColorKeys_Change(.lstColorKeys)
		SetColors
