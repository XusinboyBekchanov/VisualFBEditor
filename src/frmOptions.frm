...
Private Sub frmOptions.cmdChangeAIAgent_Click(ByRef Sender As Control)
	With fOptions
		...
		frmAIAgent.cboAIAgentHost.ItemIndex = frmAIAgent.cboAIAgentHost.IndexOf(.lvAIAgentTypes.SelectedItem->Text(1))
		frmAIAgent.cboAIAgentPort.ItemIndex = frmAIAgent.cboAIAgentPort.IndexOf(.lvAIAgentTypes.SelectedItem->Text(2))
		frmAIAgent.cboAIAgentAddress.ItemIndex = frmAIAgent.cboAIAgentAddress.IndexOf(.lvAIAgentTypes.SelectedItem->Text(3))
		frmAIAgent.cboAIAgentModelName.ItemIndex = frmAIAgent.cboAIAgentModelName.IndexOf(.lvAIAgentTypes.SelectedItem->Text(4))
		frmAIAgent.cboAIAgentProvider.ItemIndex = frmAIAgent.IndexOf(.lvAIAgentTypes.SelectedItem->Text(5))
