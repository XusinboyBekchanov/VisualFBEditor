...
Private Sub frmOptions.cboTheme_Change(ByRef Sender As Control)
	With fOptions
		...
		.Colors(16 + k, 0) = piniTheme->ReadInteger("Colors", "OperatorsForeground", -1)
		.Colors(16 + k, 1) = piniTheme->ReadInteger("Colors", "OperatorsBackground", -1)
		.Colors(16 + k, 2) = piniTheme->ReadInteger("Colors", "OperatorsFrame", -1)
		.Colors(16 + k, 4) = piniTheme->ReadInteger("FontStyles", "OperatorsBold", 0)
		.Colors(16 + k, 5) = piniTheme->ReadInteger("FontStyles", "OperatorsItalic", 0)
		.Colors(16 + k, 6) = piniTheme->ReadInteger("FontStyles", "OperatorsUnderline", 0)
