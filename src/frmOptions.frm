...
Private Sub frmOptions.cboTheme_Change(ByRef Sender As Control)
	With fOptions
		...
		.Colors(13 + k, 0) = piniTheme->ReadInteger("Colors", "SelectionForeground", -1)
		.Colors(13 + k, 1) = piniTheme->ReadInteger("Colors", "SelectionBackground", -1)
		.Colors(13 + k, 2) = piniTheme->ReadInteger("Colors", "SelectionFrame", -1)
		.Colors(14 + k, 0) = piniTheme->ReadInteger("Colors", "SpaceIdentifiersForeground", -1)
		.Colors(15 + k, 0) = piniTheme->ReadInteger("Colors", "StringsForeground", -1)
		.Colors(15 + k, 1) = piniTheme->ReadInteger("Colors", "StringsBackground", -1)
		.Colors(15 + k, 2) = piniTheme->ReadInteger("Colors", "StringsFrame", -1)
		.Colors(15 + k, 4) = piniTheme->ReadInteger("FontStyles", "StringsBold", 0)
		.Colors(15 + k, 5) = piniTheme->ReadInteger("FontStyles", "StringsItalic", 0)
		.Colors(15 + k, 6) = piniTheme->ReadInteger("FontStyles", "StringsUnderline", 0)
		.lstColorKeys_Change(.lstColorKeys)
