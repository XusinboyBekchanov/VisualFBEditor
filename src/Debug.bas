...
private sub string_sh(tv As HWND)
...
private sub shwexp_new(tview As HWND) '24/11/2014
...
Sub brk_apply
    ...
    For i As Integer = 0 To tabCode.TabCount - 1
        ...
        For j As Integer = 0 To sourcenb
    			     If LCase(source(j)) = LCase(tb->FileName) Then
...
Dim Shared AS Integer fntab, fcurlig
