...
Sub CreateMenusAndToolBars
	...
	miTry->Add("-")
	miProjectMacroNumbering = miTry->Add(ML("Modular macro numbering") & HK("ProjectMacroNumberOn"), "Numbering", "ProjectMacroNumberOn", @mClick, , , False)
	miProjectMacroNumberingStartsOfProcedures = miTry->Add(ML("Modular macro numbering: Starts of procedures") & HK("ProjectMacroNumberOnStartsOfProcs"), "", "ProjectMacroNumberOnStartsOfProcs", @mClick, , , False)
	miRemoveProjectNumbering = miTry->Add(ML("Remove Modular numbering") & HK("ProjectNumberOff"), "", "ProjectNumberOff", @mClick, , , False)
	miTry->Add("-")
	...
	miTry->Add("-")
	miProjectPreprocessorNumbering = miTry->Add(ML("Modular preprocessor numbering") & HK("ProjectPreprocessorNumberOn"), "Numbering", "ProjectPreprocessorNumberOn", @mClick, , , False)
	miRemoveProjectPreprocessorNumbering = miTry->Add(ML("Remove Modular preprocessor numbering") & HK("ProjectPreprocessorNumberOff"), "", "ProjectPreprocessorNumberOff", @mClick, , , False)
	miTry->Add("-")
	...
	tbButton->DropDownMenu.Add "-"
dmiProjectMacroNumbering = tbButton->DropDownMenu.Add(ML("Modular macro numbering"), "Numbering", "ProjectMacroNumberOn", @mClick, , , False)
	dmiProjectMacroNumberingStartsOfProcedures = tbButton->DropDownMenu.Add(ML("Modular macro numbering: Starts of procedures"), "", "ProjectMacroNumberOnStartsOfProcs", @mClick, , , False)
	dmiRemoveProjectNumbering = tbButton->DropDownMenu.Add(ML("Remove Modular numbering"), "", "ProjectNumberOff", @mClick, , , False)
	tbButton->DropDownMenu.Add "-"
	...
	tbButton->DropDownMenu.Add "-"
	dmiProjectPreprocessorNumbering = tbButton->DropDownMenu.Add(ML("Modular preprocessor numbering"), "Numbering", "ProjectPreprocessorNumberOn", @mClick, , , False)
	dmiRemoveProjectPreprocessorNumbering = tbButton->DropDownMenu.Add(ML("Remove Modular preprocessor numbering"), "", "ProjectPreprocessorNumberOff", @mClick, , , False)
	tbButton->DropDownMenu.Add "-"
