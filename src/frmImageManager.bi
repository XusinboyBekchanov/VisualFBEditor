'#Region "Form"
	...
	Type frmImageManager Extends Form
		...
		Declare Static Sub optCustom_Click_(ByRef Sender As RadioButton)
		Declare Sub optCustom_Click(ByRef Sender As RadioButton)
		Declare Static Sub opt16x16_Click_(ByRef Sender As RadioButton)
		Declare Sub opt16x16_Click(ByRef Sender As RadioButton)
		Declare Static Sub opt32x32_Click_(ByRef Sender As RadioButton)
