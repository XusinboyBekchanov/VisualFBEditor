...
wget -O FreeBASIC-1.10.1-freebsd-x86_64.tar.gz https://sourceforge.net/projects/fbc/files/FreeBASIC-1.10.1/Binaries-FreeBSD/FreeBASIC-1.10.1-freebsd-x86_64.tar.gz
tar xf FreeBASIC-1.10.1-freebsd-x86_64.tar.gz
