...
`TabPage` - `TabPage` - Represents a single tab page in a TabControl.

## Properties
|Name|Description|
| :------------ | :------------ |
|[`_Box`]("TabPage._Box.md")||
|[`_Icon`]("TabPage._Icon.md")||
|[`_Label`]("TabPage._Label.md")||
...
|[`Graphic`]("Panel.Graphic.md")|Returns/sets a graphic to be displayed in a control (Windows, Linux).|
...
|[`ImageIndex`]("TabPage.ImageIndex.md")||
|[`ImageKey`]("TabPage.ImageKey.md")||
|[`Index`]("TabPage.Index.md")||
...
|[`Object`]("TabPage.Object.md")||
|[`Parent`]("TabPage.Parent.md")||
...
|[`Transparent`]("Panel.Transparent.md")||
|[`UseVisualStyleBackColor`]("TabPage.UseVisualStyleBackColor.md")|Determines if the control uses visual style colors for background|
|[`Visible`]("TabPage.Visible.md")|Returns/sets a value that determines whether an object is visible or hidden (Windows, Linux).|
...
|[`HandleIsAllocated`]("TabPage.HandleIsAllocated.md")|Checks if the window handle has been created|
...
|[`IsSelected`]("TabPage.IsSelected.md")|Determines if this tab page is currently selected|
|[`ProcessMessage`]("TabPage.ProcessMessage.md")|Processes Windows messages for the control|
|[`ReadProperty`]("TabPage.ReadProperty.md")|Reads a property value from a stream|
...
|[`SelectTab`]("TabPage.SelectTab.md")|Makes this tab page the active/selected tab|
...
|[`Update`]("TabPage.Update.md")|Forces the control to redraw invalid regions|
...
|[`WriteProperty`]("TabPage.WriteProperty.md")|Writes a property value to a stream|
## Events
|Name|Description|
| :------------ | :------------ |
...
|[`OnDeSelected`]("TabPage.OnDeSelected.md") |Triggered when the tab page loses selection|
...
|[`OnSelected`]("TabPage.OnSelected.md") |Triggered when the tab page becomes selected|
## See also
Namespace: [`My.Sys.Forms`](My.Sys.Forms.md)
