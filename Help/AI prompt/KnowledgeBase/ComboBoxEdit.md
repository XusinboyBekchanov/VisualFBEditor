...
`ComboBoxEdit` - `ComboBoxEdit` is a Control within the MyFbFramework, part of the freeBasic framework. <br> `ComboBoxEdit` - Combines the features of a [[TextBox]] and a [[ListControl]].
...
|[`DropDownCount`]("ComboBoxEdit.DropDownCount.md")||
...
|[`IntegralHeight`]("ComboBoxEdit.IntegralHeight.md")||
...
|[`Item`]("ComboBoxEdit.Item.md")|Access items by index (default property).|
|[`ItemCount`]("ComboBoxEdit.ItemCount.md")||
|[`ItemData`]("ComboBoxEdit.ItemData.md")|Associated data with list items.|
|[`ItemHeight`]("ComboBoxEdit.ItemHeight.md")||
|[`ItemIndex`]("ComboBoxEdit.ItemIndex.md")||
|[`Items`]("ComboBoxEdit.Items.md")|Collection of list items.|
...
|[`SelColor`]("ComboBoxEdit.SelColor.md")||
...
|[`AddItem`]("ComboBoxEdit.AddItem.md")|Appends new item to list.|
...
|[`Contains`]("ComboBoxEdit.Contains.md")|Checks if item exists in list.|
...
|[`CopyToClipboard`]("ComboBoxEdit.CopyToClipboard.md")||
|[`CreateWnd`]("Control.CreateWnd.md")|Creates the window (Windows, Android, Web)|
|[`CutToClipboard`]("ComboBoxEdit.CutToClipboard.md")||
...
|[`IndexOf`]("ComboBoxEdit.IndexOf.md")|Returns item index by text.|
|[`IndexOfData`]("ComboBoxEdit.IndexOfData.md")|Finds index by associated data.|
|[`InsertItem`]("ComboBoxEdit.InsertItem.md")|Inserts item at position.|
...
|[`LoadFromFile`]("ComboBoxEdit.LoadFromFile.md")|Loads items from text file.|
|[`NewIndex`]("ComboBoxEdit.NewIndex.md")||
|[`PasteFromClipboard`]("ComboBoxEdit.PasteFromClipboard.md")||
|[`ProcessMessage`]("Control.ProcessMessage.md")||
|[`ReadProperty`]("ComboBoxEdit.ReadProperty.md")|Loads persisted properties.|
|[`RecreateWnd`]("Control.RecreateWnd.md")|Recreates the window (Windows only)|
|[`RegisterClass`]("ComboBoxEdit.RegisterClass.md")||
|[`Remove`]("Control.Remove.md")|Removes the specified control from the control collection (Windows, Linux, Android, Web).|
|[`RemoveItem`]("ComboBoxEdit.RemoveItem.md")|Deletes item by index.|
...
|[`SaveToFile`]("ComboBoxEdit.SaveToFile.md")|Saves items to text file.|
...
|[`SelectAll`]("ComboBoxEdit.SelectAll.md")||
...
|[`ShowDropDown`]("ComboBoxEdit.ShowDropDown.md")|Opens/closes dropdown list.|
...
|[`WriteProperty`]("ComboBoxEdit.WriteProperty.md")|Persists properties to storage.|
## Events
|Name|Description|
| :------------ | :------------ |
|[`OnActivate`]("ComboBoxEdit.OnActivate.md") |Raised when control gains focus.|
|[`OnChange`]("ComboBoxEdit.OnChange.md") |Triggered on text/item selection change.|
|[`OnClick`]("Control.OnClick.md") |Occurs when the control is clicked (Windows, Linux, Android, Web).|
|[`OnCloseUp`]("ComboBoxEdit.OnCloseUp.md") |Raised when dropdown closes.|
...
|[`OnDrawItem`]("ComboBoxEdit.OnDrawItem.md") |Custom item rendering event.|
|[`OnDropDown`]("ComboBoxEdit.OnDropDown.md") |Raised when dropdown opens.|
...
|[`OnKeyDown`]("ComboBoxEdit.OnKeyDown.md") |Triggered by keyboard key press.|
|[`OnKeyPress`]("ComboBoxEdit.OnKeyPress.md") |Triggered by character input.|
|[`OnKeyUp`]("ComboBoxEdit.OnKeyUp.md") |Triggered by keyboard key release.|
|[`OnLostFocus`]("Control.OnLostFocus.md") |Occurs when the control loses focus (Windows, Linux, Web).|
|[`OnMeasureItem`]("ComboBoxEdit.OnMeasureItem.md") |Custom item sizing event.|
...
|[`OnSelectCanceled`]("ComboBoxEdit.OnSelectCanceled.md") |Raised when selection aborted.|
|[`OnSelected`]("ComboBoxEdit.OnSelected.md") |Triggered after item selection.|
## See also
Namespace: [`My.Sys.Forms`](My.Sys.Forms.md)
