...
|Name|Description|
| :------------ | :------------ |
|[`Column`]("TreeListViewColumns.Column.md")||
|[`Count`]("TreeListViewColumns.Count.md")||
...
|[`Parent`]("TreeListViewColumns.Parent.md")|Reference to parent TreeListView control|
...
|Name|Description|
| :------------ | :------------ |
|[`Add`]("TreeListViewColumns.Add.md")|Creates and appends new item|
|[`ClassName`]("My.Sys.Object.ClassName.md")|Used to get correct class name of the object (Windows, Linux, Android, Web).|
|[`Clear`]("TreeListViewColumns.Clear.md")|Removes all items from collection|
...
|[`IndexOf`]("TreeListViewColumns.IndexOf.md")|Zero-based position in column collection|
|[`Insert`]("TreeListViewColumns.Insert.md")|Adds item at specified position|
...
|[`Remove`]("TreeListViewColumns.Remove.md")|Deletes specified item|
