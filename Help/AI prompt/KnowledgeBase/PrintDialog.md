...
|Name|Description|
| :------------ | :------------ |
|[`AllowToFile`]("PrintDialog.AllowToFile.md")||
|[`AllowToNetwork`]("PrintDialog.AllowToNetwork.md")||
|[`Caption`]("PrintDialog.Caption.md")||
...
|[`PrinterName`]("PrintDialog.PrinterName.md")||
|[`SetupDialog`]("PrintDialog.SetupDialog.md")|Declare Property Left() As Integer <br> Declare Property Left(value As Integer) <br> Declare Property Top() As Integer <br> Declare Property Top(value As Integer)|
|[`ShowHelpButton`]("PrintDialog.ShowHelpButton.md")||
...
|[`ToPage`]("PrintDialog.ToPage.md")||
|[`Width`]("PrintDialog.Width.md")||
|[`xdpi`]("My.Sys.Object.xdpi.md")|Horizontal DPI scaling factor (Windows, Linux, Android, Web).|
|[`xSetupDialog`]("PrintDialog.xSetupDialog.md")||
...
|[`Execute`]("PrintDialog.Execute.md")||
