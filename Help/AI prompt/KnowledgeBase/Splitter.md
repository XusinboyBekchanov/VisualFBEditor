...
`Splitter` - `Splitter` is a Control within the MyFbFramework, part of the freeBasic framework. <br> `Splitter` - Represents a splitter control that enables the user to resize docked controls.

## Properties
|Name|Description|
| :------------ | :------------ |
|[`Align`]("Splitter.Align.md")||
...
|[`MinExtra`]("Splitter.MinExtra.md")|Sets minimum space required on both sides of the splitter|
...
|[`ReadProperty`]("Splitter.ReadProperty.md")|Deserializes properties from persistence stream|
...
|[`WriteProperty`]("Splitter.WriteProperty.md")|Serializes properties to persistence stream|
## Events
|Name|Description|
| :------------ | :------------ |
...
|[`OnMoved`]("Splitter.OnMoved.md") |Triggered after splitter completes resizing|
|[`OnMoving`]("Splitter.OnMoving.md") |Raised during active resizing operations|
|[`OnPaint`]("Splitter.OnPaint.md") |Allows custom splitter appearance rendering|
