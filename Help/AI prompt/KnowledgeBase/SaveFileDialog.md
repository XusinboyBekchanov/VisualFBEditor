...
|Name|Description|
| :------------ | :------------ |
|[`Caption`]("SaveFileDialog.Caption.md")||
|[`Center`]("SaveFileDialog.Center.md")||
|[`Color`]("SaveFileDialog.Color.md")||
|[`DefaultExt`]("SaveFileDialog.DefaultExt.md")||
...
|[`FileName`]("SaveFileDialog.FileName.md")||
|[`Filter`]("SaveFileDialog.Filter.md")||
|[`FilterIndex`]("SaveFileDialog.FilterIndex.md")||
...
|[`InitialDir`]("SaveFileDialog.InitialDir.md")||
...
|[`Options`]("SaveFileDialog.Options.md")||
...
|[`Execute`]("SaveFileDialog.Execute.md")||
...
|[`ReadProperty`]("SaveFileDialog.ReadProperty.md")||
...
|[`WriteProperty`]("SaveFileDialog.WriteProperty.md")||
## Events
|Name|Description|
| :------------ | :------------ |
|[`OnFolderChange`]("SaveFileDialog.OnFolderChange.md") ||
|[`OnSelectionChange`]("SaveFileDialog.OnSelectionChange.md") ||
|[`OnTypeChange`]("SaveFileDialog.OnTypeChange.md") ||
