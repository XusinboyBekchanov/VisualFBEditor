...
`RadioButton` - `RadioButton` is a Control within the MyFbFramework, part of the freeBasic framework. <br> `RadioButton` - Displays an option that can be turned on or off.
...
|[`Alignment`]("RadioButton.Alignment.md")||
...
|[`Caption`]("RadioButton.Caption.md")||
|[`Checked`]("RadioButton.Checked.md")||
...
|[`Grouped`]("RadioButton.Grouped.md")||
...
|[`ReadProperty`]("RadioButton.ReadProperty.md")|Loads state from persistence stream|
...
|[`WriteProperty`]("RadioButton.WriteProperty.md")|Saves state to persistence stream|
## Events
|Name|Description|
| :------------ | :------------ |
|[`OnClick`]("RadioButton.OnClick.md") |Triggered when selection state changes|
