...
`Header` - `Header` is a Control within the MyFbFramework, part of the freeBasic framework. <br> `Header` - A header control is a window that is usually positioned above columns of text or numbers.
...
|[`Alignments`]("Header.Alignments.md")|Text alignment for each section (Left/Center/Right)|
...
|[`Captions`]("Header.Captions.md")|Text labels collection for header sections|
...
|[`DragReorder`]("Header.DragReorder.md")||
...
|[`ImageIndexes`]("Header.ImageIndexes.md")|Image list indices for section icons|
|[`Images`]("Header.Images.md")|Image list resource for section graphics|
...
|[`Resizable`]("Header.Resizable.md")||
|[`Section`]("Header.Section.md")|Access individual section properties by index|
|[`SectionCount`]("Header.SectionCount.md")||
...
|[`Widths`]("Header.Widths.md")|Width values for each section|
...
|[`AddSection`]("Header.AddSection.md")|Appends new header section|
|[`AddSections`]("Header.AddSections.md")|Adds multiple sections at once|
...
|[`ReadProperty`]("Header.ReadProperty.md")|Loads persisted section configuration|
...
|[`RemoveSection`]("Header.RemoveSection.md")|Deletes specified section|
...
|[`UpdateItems`]("Header.UpdateItems.md")|Refreshes header display|
...
|[`WriteProperty`]("Header.WriteProperty.md")|Saves section configuration|
## Events
|Name|Description|
| :------------ | :------------ |
|[`OnBeginTrack`]("Header.OnBeginTrack.md") |Raised when user starts resizing a section|
|[`OnChange`]("Header.OnChange.md") |Triggered after section modification completes|
|[`OnChanging`]("Header.OnChanging.md") |Triggered before section changes occur|
...
|[`OnDividerDblClick`]("Header.OnDividerDblClick.md") |Double-click detection on section divider|
|[`OnDrawSection`]("Header.OnDrawSection.md") |Custom section painting event|
...
|[`OnEndTrack`]("Header.OnEndTrack.md") |Raised after section resizing completes|
...
|[`OnSectionClick`]("Header.OnSectionClick.md") |Section header click detection|
|[`OnSectionDblClick`]("Header.OnSectionDblClick.md") |Section header double-click detection|
|[`OnTrack`]("Header.OnTrack.md") |Continuous tracking during resizing|
## See also
Namespace: [`My.Sys.Forms`](My.Sys.Forms.md)
