...
|[`Detachable`]("TabControl.Detachable.md")||
...
|[`FlatButtons`]("TabControl.FlatButtons.md")||
...
|[`GroupName`]("TabControl.GroupName.md")||
...
|[`Multiline`]("TabControl.Multiline.md")||
...
|[`Reorderable`]("TabControl.Reorderable.md")||
|[`SelectedTab`]("TabControl.SelectedTab.md")||
|[`SelectedTabIndex`]("TabControl.SelectedTabIndex.md")||
...
|[`Tab`]("TabControl.Tab.md")||
|[`TabCount`]("TabControl.TabCount.md")||
|[`TabIndex`]("TabControl.TabIndex.md")||
|[`TabPosition`]("TabControl.TabPosition.md")||
|[`Tabs`]("TabControl.Tabs.md")||
|[`TabStop`]("TabControl.TabStop.md")||
|[`TabStyle`]("TabControl.TabStyle.md")||
...
|[`DeleteTab`]("TabControl.DeleteTab.md")||
...
|[`IndexOfTab`]("TabControl.IndexOfTab.md")|Gets the zero-based index of the tab page in its parent TabControl|
|[`InsertTab`]("TabControl.InsertTab.md")||
...
|[`ItemHeight`]("TabControl.ItemHeight.md")||
|[`ItemLeft`]("TabControl.ItemLeft.md")||
|[`ItemTop`]("TabControl.ItemTop.md")||
|[`ItemWidth`]("TabControl.ItemWidth.md")||
|[`ProcessMessage`]("Control.ProcessMessage.md")||
|[`ReadProperty`]("TabControl.ReadProperty.md")|Reads a property value from a stream|
...
|[`ReorderTab`]("TabControl.ReorderTab.md")||
...
|[`WriteProperty`]("TabControl.WriteProperty.md")|Writes a property value to a stream|
## Events
|Name|Description|
| :------------ | :------------ |
...
|[`OnGotFocus`]("TabControl.OnGotFocus.md") ||
...
|[`OnLostFocus`]("TabControl.OnLostFocus.md") ||
...
|[`OnSelChange`]("TabControl.OnSelChange.md") ||
|[`OnSelChanging`]("TabControl.OnSelChanging.md") ||
|[`OnTabAdded`]("TabControl.OnTabAdded.md") ||
|[`OnTabRemoved`]("TabControl.OnTabRemoved.md") ||
|[`OnTabReordered`]("TabControl.OnTabReordered.md") ||
## See also
Namespace: [`My.Sys.Forms`](My.Sys.Forms.md)
