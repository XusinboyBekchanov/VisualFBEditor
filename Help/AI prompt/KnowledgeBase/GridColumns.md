...
|Name|Description|
| :------------ | :------------ |
|[`Column`]("GridColumns.Column.md")||
|[`Count`]("GridColumns.Count.md")||
...
|[`Parent`]("GridColumns.Parent.md")|Reference to containing grid control|
...
|[`IndexOf`]("GridColumns.IndexOf.md")|Ordinal position within parent grid columns|
|[`Insert`]("GridColumns.Insert.md")||
