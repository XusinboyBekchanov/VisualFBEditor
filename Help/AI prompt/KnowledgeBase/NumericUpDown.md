...
`NumericUpDown` - `NumericUpDown` is a Control within the MyFbFramework, part of the freeBasic framework. <br> `NumericUpDown` - Allows numeric input via textbox with increment/decrement buttons and value constraints.
...
|[`ArrowKeys`]("NumericUpDown.ArrowKeys.md")||
...
|[`DecimalPlaces`]("NumericUpDown.DecimalPlaces.md")||
...
|[`Increment`]("NumericUpDown.Increment.md")||
...
|[`MaxValue`]("NumericUpDown.MaxValue.md")||
|[`MinValue`]("NumericUpDown.MinValue.md")||
...
|[`Position`]("NumericUpDown.Position.md")||
...
|[`UpDownWidth`]("NumericUpDown.UpDownWidth.md")||
...
|[`ProcessMessage`]("NumericUpDown.ProcessMessage.md")|Processes Windows API messages|
|[`ReadProperty`]("NumericUpDown.ReadProperty.md")|Loads configuration from data stream|
...
|[`SelectAll`]("NumericUpDown.SelectAll.md")|Highlights all text content|
...
|[`WriteProperty`]("NumericUpDown.WriteProperty.md")|Saves configuration to data stream|
## Events
|Name|Description|
| :------------ | :------------ |
|[`OnChange`]("NumericUpDown.OnChange.md") |Raised when value changes via any input method|
