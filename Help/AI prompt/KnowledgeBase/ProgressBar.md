...
`ProgressBar` - `ProgressBar` is a Control within the MyFbFramework, part of the freeBasic framework. <br> `ProgressBar` - A progress bar is a window that an application can use to indicate the progress of a lengthy operation.
...
|[`Smooth`]("ProgressBar.Smooth.md")||
|[`StepValue`]("ProgressBar.StepValue.md")||
...
|[`ReadProperty`]("ProgressBar.ReadProperty.md")|Loads configuration from persistence stream|
...
|[`SetMarquee`]("ProgressBar.SetMarquee.md")|Starts marquee animation with specified speed|
|[`Show`]("Control.Show.md")|Displays the control to the user (Windows, Linux, Android, Web).|
|[`StepBy`]("ProgressBar.StepBy.md")|Advances position by custom delta|
|[`StepIt`]("ProgressBar.StepIt.md")|Advances position by StepValue|
|[`StopMarquee`]("ProgressBar.StopMarquee.md")|Terminates marquee animation|
...
|[`WriteProperty`]("ProgressBar.WriteProperty.md")|Saves configuration to persistence stream|
## Events
|Name|Description|
| :------------ | :------------ |
