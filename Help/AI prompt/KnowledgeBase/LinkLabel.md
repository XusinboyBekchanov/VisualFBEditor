...
`LinkLabel` - `LinkLabel` is a Control within the MyFbFramework, part of the freeBasic framework. <br> `LinkLabel` - Represents a label control that can display hyperlinks.
...
|[`ReadProperty`]("LinkLabel.ReadProperty.md")|Loads hyperlink settings from stream|
...
|[`WriteProperty`]("LinkLabel.WriteProperty.md")|Saves hyperlink configuration to stream|
## Events
|Name|Description|
| :------------ | :------------ |
...
|[`OnLinkClicked`]("LinkLabel.OnLinkClicked.md") |Triggered when hyperlink is activated|
