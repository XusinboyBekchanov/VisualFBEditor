...
|[`Handle`]("Brush.Handle.md")||
|[`HatchStyle`]("Brush.HatchStyle.md")||
|[`Parent`]("Brush.Parent.md")||
|[`Style`]("Brush.Style.md")||
...
|[`ReadProperty`]("Brush.ReadProperty.md")||
...
|[`WriteProperty`]("Brush.WriteProperty.md")||
## Events
|Name|Description|
| :------------ | :------------ |
|[`OnCreate`]("Brush.OnCreate.md") ||
## See also
Namespace: [`My.Sys.Drawing`](My.Sys.Drawing.md)
