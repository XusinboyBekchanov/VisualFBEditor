...
`DateTimePicker` - `DateTimePicker` is a Control within the MyFbFramework, part of the freeBasic framework. <br> `DateTimePicker` - Represents a Windows control that allows the user to select a date and a time and to display the date and time with a specified format.
...
|[`AutoNextPart`]("DateTimePicker.AutoNextPart.md")||
...
|[`CalendarRightAlign`]("DateTimePicker.CalendarRightAlign.md")||
|[`Canvas`]("Control.Canvas.md")|Canvas is all about drawing in a container (Windows, Linux).|
|[`Checked`]("DateTimePicker.Checked.md")||
...
|[`CustomFormat`]("DateTimePicker.CustomFormat.md")||
|[`DateFormat`]("DateTimePicker.DateFormat.md")||
...
|[`SelectedDate`]("DateTimePicker.SelectedDate.md")||
|[`SelectedDateTime`]("DateTimePicker.SelectedDateTime.md")||
|[`SelectedTime`]("DateTimePicker.SelectedTime.md")||
...
|[`ShowNone`]("DateTimePicker.ShowNone.md")||
|[`ShowUpDown`]("DateTimePicker.ShowUpDown.md")||
...
|[`TabIndex`]("DateTimePicker.TabIndex.md")||
|[`TabStop`]("DateTimePicker.TabStop.md")||
|[`Tag`]("Component.Tag.md")|Stores any extra data needed for your program (Windows, Linux, Android, Web).|
|[`Text`]("DateTimePicker.Text.md")||
|[`TimePicker`]("DateTimePicker.TimePicker.md")||
...
|[`ReadProperty`]("DateTimePicker.ReadProperty.md")|Loads configuration from persistence stream|
...
|[`WriteProperty`]("DateTimePicker.WriteProperty.md")|Saves configuration to persistence stream|
## Events
|Name|Description|
| :------------ | :------------ |
...
|[`OnDateTimeChanged`]("DateTimePicker.OnDateTimeChanged.md") |Triggered when date/time value changes|
