...
`PagePanel` - Used to group collections of controls.
...
|[`Graphic`]("PagePanel.Graphic.md")|Returns/sets a graphic to be displayed in a control (Windows, Linux).|
...
|[`SelectedPanel`]("PagePanel.SelectedPanel.md")||
|[`SelectedPanelIndex`]("PagePanel.SelectedPanelIndex.md")||
...
|[`TabIndex`]("PagePanel.TabIndex.md")||
|[`TabStop`]("PagePanel.TabStop.md")||
...
|[`Transparent`]("PagePanel.Transparent.md")||
...
|[`CreateWnd`]("PagePanel.CreateWnd.md")||
...
|[`ReadProperty`]("PagePanel.ReadProperty.md")||
...
|[`WriteProperty`]("PagePanel.WriteProperty.md")||
## Events
|Name|Description|
| :------------ | :------------ |
...
|[`OnSelChange`]("PagePanel.OnSelChange.md") ||
|[`OnSelChanging`]("PagePanel.OnSelChanging.md") ||
## See also
Namespace: [`My.Sys.Forms`](My.Sys.Forms.md)
