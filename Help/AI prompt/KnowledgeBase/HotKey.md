...
`HotKey` - `HotKey` is a Control within the MyFbFramework, part of the freeBasic framework. <br> `HotKey` - A hot key control is a window that enables the user to enter a combination of keystrokes to be used as a hot key.
...
|[`TabIndex`]("HotKey.TabIndex.md")||
|[`TabStop`]("HotKey.TabStop.md")||
...
|[`ReadProperty`]("HotKey.ReadProperty.md")|Loads hotkey configuration from persistence stream|
...
|[`WriteProperty`]("HotKey.WriteProperty.md")|Saves hotkey configuration to persistence stream|
## Events
|Name|Description|
| :------------ | :------------ |
|[`OnChange`]("HotKey.OnChange.md") |Triggered when key combination is modified|
