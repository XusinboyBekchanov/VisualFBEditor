...
|Name|Description|
| :------------ | :------------ |
|[`CallMethod`]("HTTPConnection.CallMethod.md")||
...
|[`ReadProperty`]("HTTPConnection.ReadProperty.md")||
...
|[`WriteProperty`]("HTTPConnection.WriteProperty.md")||
## Events
|Name|Description|
| :------------ | :------------ |
|[`OnReceive`]("HTTPConnection.OnReceive.md") ||
## See also
Namespace: [`My.Sys.Forms`](My.Sys.Forms.md)
