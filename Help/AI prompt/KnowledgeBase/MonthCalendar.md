...
`MonthCalendar` - `MonthCalendar` is a Control within the MyFbFramework, part of the freeBasic framework. <br> `MonthCalendar` - Represents a Windows control that enables the user to select a date using a visual monthly calendar display.
...
|[`SelectedDate`]("MonthCalendar.SelectedDate.md")|Currently selected date value|
|[`ShortDayNames`]("MonthCalendar.ShortDayNames.md")|Custom abbreviated day names (e.g., "Mon", "Tue")|
...
|[`TabIndex`]("MonthCalendar.TabIndex.md")||
|[`TabStop`]("MonthCalendar.TabStop.md")||
...
|[`TodayCircle`]("MonthCalendar.TodayCircle.md")|Highlights current date with circular marker|
|[`TodaySelector`]("MonthCalendar.TodaySelector.md")|Visually indicates today's date|
...
|[`TrailingDates`]("MonthCalendar.TrailingDates.md")|Displays dates from adjacent months (grayed out)|
|[`Visible`]("Control.Visible.md")|Returns/sets a value that determines whether an object is visible or hidden (Windows, Linux, Web).|
|[`WeekNumbers`]("MonthCalendar.WeekNumbers.md")|Shows week numbers in left margin|
...
|[`ReadProperty`]("MonthCalendar.ReadProperty.md")|Loads calendar config from persistence stream|
...
|[`WriteProperty`]("MonthCalendar.WriteProperty.md")|Saves calendar config to persistence stream|
## Events
|Name|Description|
| :------------ | :------------ |
...
|[`OnSelect`]("MonthCalendar.OnSelect.md") |Triggered during date selection|
|[`OnSelectionChanged`]("MonthCalendar.OnSelectionChanged.md") |Raised after date selection changes|
## See also
Namespace: [`My.Sys.Forms`](My.Sys.Forms.md)
