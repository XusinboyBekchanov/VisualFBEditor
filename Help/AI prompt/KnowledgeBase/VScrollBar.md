...
`VScrollBar` - `VScrollBar` is a Control within the MyFbFramework, part of the freeBasic framework. <br> `VScrollBar` - Provides a vertical scroll bar.
...
|[`ArrowChangeSize`]("VScrollBar.ArrowChangeSize.md")||
...
|[`TabIndex`]("VScrollBar.TabIndex.md")||
|[`TabStop`]("VScrollBar.TabStop.md")||
...
|[`ReadProperty`]("VScrollBar.ReadProperty.md")|Reads property value from persistence stream|
...
|[`WriteProperty`]("VScrollBar.WriteProperty.md")|Writes property value to persistence stream|
## Events
|Name|Description|
| :------------ | :------------ |
...
|[`OnScroll`]("VScrollBar.OnScroll.md") |Triggered when scroll position changes|
## See also
Namespace: [`My.Sys.Forms`](My.Sys.Forms.md)
