...
`CheckBox` - `CheckBox` is a Control within the MyFbFramework, part of the freeBasic framework. <br> `CheckBox` - Displays an V when selected; the V disappears when the CheckBox is cleared.
...
|[`Alignment`]("CheckBox.Alignment.md")||
...
|[`ReadProperty`]("CheckBox.ReadProperty.md")|Loads checkbox state from persistence stream|
...
|[`WriteProperty`]("CheckBox.WriteProperty.md")|Saves checkbox state to persistence stream|
## Events
|Name|Description|
| :------------ | :------------ |
|[`OnClick`]("CheckBox.OnClick.md") |Triggered when checkbox is clicked|
