...
`TreeView` - `TreeView` is a Control within the MyFbFramework, part of the freeBasic framework. <br> `TreeView` - Represents a control that displays hierarchical data in a tree structure that has items that can expand and collapse.
...
|[`EditLabels`]("TreeView.EditLabels.md")||
...
|[`HideSelection`]("TreeView.HideSelection.md")||
...
|[`Images`]("TreeView.Images.md")|Image list for normal node icons|
...
|[`CollapseAll`]("TreeView.CollapseAll.md")|Collapses all expanded nodes|
...
|[`DraggedNode`]("TreeView.DraggedNode.md")|Returns node being dragged during OLE operations|
|[`ExpandAll`]("TreeView.ExpandAll.md")|Expands all collapsible nodes|
...
|[`ReadProperty`]("TreeView.ReadProperty.md")|Loads persisted tree structure|
...
|[`WriteProperty`]("TreeView.WriteProperty.md")|Saves tree configuration|
## Events
|Name|Description|
| :------------ | :------------ |
|[`OnAfterLabelEdit`]("TreeView.OnAfterLabelEdit.md") |Raised after node text editing completes|
|[`OnBeforeLabelEdit`]("TreeView.OnBeforeLabelEdit.md") |Triggered before node text editing begins|
...
|[`OnNodeActivate`]("TreeView.OnNodeActivate.md") |Raised when node is activated via keyboard|
|[`OnNodeClick`]("TreeView.OnNodeClick.md") |Triggered on mouse click node selection|
|[`OnNodeCollapsed`]("TreeView.OnNodeCollapsed.md") |After node collapse completes|
|[`OnNodeCollapsing`]("TreeView.OnNodeCollapsing.md") |Before node collapse occurs|
|[`OnNodeDblClick`]("TreeView.OnNodeDblClick.md") |Double-click node detection|
|[`OnNodeExpanded`]("TreeView.OnNodeExpanded.md") |After node expansion completes|
|[`OnNodeExpanding`]("TreeView.OnNodeExpanding.md") |Before node expansion occurs|
...
|[`OnSelChanged`]("TreeView.OnSelChanged.md") |After selection changes|
|[`OnSelChanging`]("TreeView.OnSelChanging.md") |Before selection changes|
## See also
Namespace: [`My.Sys.Forms`](My.Sys.Forms.md)
