...
`ImageBox` - `ImageBox` is a Control within the MyFbFramework, part of the freeBasic framework. <br> `ImageBox` - Displays a graphic.
...
|[`CenterImage`]("ImageBox.CenterImage.md")||
...
|[`DesignMode`]("ImageBox.DesignMode.md")||
...
|[`Graphic`]("ImageBox.Graphic.md")|Underlying image data object (Bitmap/Icon)|
...
|[`RealSizeImage`]("ImageBox.RealSizeImage.md")||
...
|[`ReadProperty`]("ImageBox.ReadProperty.md")|Loads image from persistence stream|
...
|[`WriteProperty`]("ImageBox.WriteProperty.md")|Saves image to persistence stream|
## Events
|Name|Description|
| :------------ | :------------ |
...
|[`OnDraw`]("ImageBox.OnDraw.md") |Triggered during image rendering|
