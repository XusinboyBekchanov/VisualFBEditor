...
`OpenFileControl` - `OpenFileControl` is a Control within the MyFbFramework, part of the freeBasic framework. <br> `OpenFileControl` - Embeds a file selection interface directly within forms, supporting multi-select and dynamic filtering.
...
|[`DefaultExt`]("OpenFileControl.DefaultExt.md")||
...
|[`FileName`]("OpenFileControl.FileName.md")||
|[`FileNames`]("OpenFileControl.FileNames.md")|Array of paths for multi-selected files|
|[`FileTitle`]("OpenFileControl.FileTitle.md")||
|[`Filter`]("OpenFileControl.Filter.md")||
|[`FilterIndex`]("OpenFileControl.FilterIndex.md")||
...
|[`InitialDir`]("OpenFileControl.InitialDir.md")||
...
|[`MultiSelect`]("OpenFileControl.MultiSelect.md")||
|[`Name`]("Component.Name.md")|Returns the name used in code to identify an object (Windows, Linux, Android, Web).|
|[`Options`]("OpenFileControl.Options.md")|Bitmask for dialog behavior flags|
...
|[`TabIndex`]("OpenFileControl.TabIndex.md")||
|[`TabStop`]("OpenFileControl.TabStop.md")||
...
|[`CreateWnd`]("OpenFileControl.CreateWnd.md")|Initializes native window handle|
...
|[`ReadProperty`]("OpenFileControl.ReadProperty.md")|Loads config from persistence stream|
...
|[`WriteProperty`]("OpenFileControl.WriteProperty.md")|Saves config to persistence stream|
## Events
|Name|Description|
| :------------ | :------------ |
...
|[`OnFileActivate`]("OpenFileControl.OnFileActivate.md") |Triggered when selection is confirmed|
|[`OnFolderChange`]("OpenFileControl.OnFolderChange.md") |Raised during directory navigation|
...
|[`OnSelectionChange`]("OpenFileControl.OnSelectionChange.md") |Fired when selected files change|
|[`OnTypeChange`]("OpenFileControl.OnTypeChange.md") |Triggered by filter type modification|
## See also
Namespace: [`My.Sys.Forms`](My.Sys.Forms.md)
