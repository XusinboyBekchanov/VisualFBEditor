...
`ToolPalette` - `ToolPalette` is a Control within the MyFbFramework, part of the freeBasic framework. <br> `ToolPalette` - A tool palette with categories.
...
|[`AutoSize`]("ToolPalette.AutoSize.md")||
...
|[`BitmapHeight`]("ToolPalette.BitmapHeight.md")||
|[`BitmapWidth`]("ToolPalette.BitmapWidth.md")||
|[`BorderStyle`]("Control.BorderStyle.md")|Returns/sets the border style for an object (Windows, Linux).|
|[`ButtonHeight`]("ToolPalette.ButtonHeight.md")||
|[`ButtonWidth`]("ToolPalette.ButtonWidth.md")||
...
|[`DisabledImagesList`]("ToolPalette.DisabledImagesList.md")||
|[`Divider`]("ToolPalette.Divider.md")||
...
|[`Groups`]("ToolPalette.Groups.md")|Collection of tool category groups|
...
|[`HotImagesList`]("ToolPalette.HotImagesList.md")||
...
|[`ImagesList`]("ToolPalette.ImagesList.md")||
...
|[`Transparency`]("ToolPalette.Transparency.md")||
...
|[`Wrapable`]("ToolPalette.Wrapable.md")||
...
|[`ReadProperty`]("ToolPalette.ReadProperty.md")|Loads properties from stream|
...
|[`WriteProperty`]("ToolPalette.WriteProperty.md")|Saves properties to stream|
## Events
|Name|Description|
| :------------ | :------------ |
|[`OnButtonActivate`]("ToolPalette.OnButtonActivate.md") |Triggered when tool becomes active (selected)|
|[`OnButtonClick`]("ToolPalette.OnButtonClick.md") |Fired when tool button is pressed|
