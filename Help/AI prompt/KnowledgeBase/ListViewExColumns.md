...
|Name|Description|
| :------------ | :------------ |
|[`Column`]("ListViewExColumns.Column.md")||
|[`Count`]("ListViewExColumns.Count.md")||
...
|[`Parent`]("ListViewExColumns.Parent.md")|Reference to parent ListViewEx control|
...
|[`IndexOf`]("ListViewExColumns.IndexOf.md")|Zero-based position in column collection|
|[`Insert`]("ListViewExColumns.Insert.md")||
...
|[`Remove`]("ListViewExColumns.Remove.md")||
