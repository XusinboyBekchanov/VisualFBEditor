...
|[`CenterImage`]("Picture.CenterImage.md")||
...
|[`RealSizeImage`]("Picture.RealSizeImage.md")||
...
|[`StretchImage`]("Picture.StretchImage.md")||
|[`Style`]("Picture.Style.md")||
|[`SubClass`]("Control.SubClass.md")|Returs/sets a value indicating type is subclass or not (Windows only).|
|[`TabIndex`]("Picture.TabIndex.md")||
|[`TabStop`]("Picture.TabStop.md")||
...
|[`Transparent`]("Picture.Transparent.md")||
...
|[`ReadProperty`]("Picture.ReadProperty.md")||
...
|[`WriteProperty`]("Picture.WriteProperty.md")||
## Events
|Name|Description|
| :------------ | :------------ |
...
|[`OnDraw`]("Picture.OnDraw.md") |OnClick    As Sub(ByRef Designer As My.Sys.Object, ByRef Sender As Picture) <br> OnDblClick As Sub(ByRef Designer As My.Sys.Object, ByRef Sender As Picture)|
