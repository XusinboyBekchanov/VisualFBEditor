...
`UpDown` - `UpDown` is a Control within the MyFbFramework, part of the freeBasic framework. <br> `UpDown` - An up-down control is a pair of arrow buttons that the user can click to increment or decrement a value, such as a scroll position or a number displayed in a companion control (called a buddy window).
...
|[`ArrowKeys`]("UpDown.ArrowKeys.md")||
|[`Associate`]("UpDown.Associate.md")||
...
|[`MaxValue`]("UpDown.MaxValue.md")||
|[`MinValue`]("UpDown.MinValue.md")||
...
|[`ProcessMessage`]("UpDown.ProcessMessage.md")|Processes Windows API messages|
|[`ReadProperty`]("UpDown.ReadProperty.md")|Loads property from serialization stream|
...
|[`WriteProperty`]("UpDown.WriteProperty.md")|Saves property to serialization stream|
## Events
|Name|Description|
| :------------ | :------------ |
|[`OnChanging`]("UpDown.OnChanging.md") |Raised before value changes occur|
