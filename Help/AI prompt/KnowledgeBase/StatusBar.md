...
`StatusBar` - `StatusBar` is a Control within the MyFbFramework, part of the freeBasic framework. <br> `StatusBar` - A status bar is a horizontal window at the bottom of a parent window in which an application can display various kinds of status information.
...
|[`BackColor`]("StatusBar.BackColor.md")||
...
|[`Count`]("StatusBar.Count.md")|Returns the number of panels in the status bar|
...
|[`Panel`]("StatusBar.Panel.md")|Indexed access to individual status panels|
|[`Panels`]("StatusBar.Panels.md")|Font          As My.Sys.Drawing.Font|
...
|[`SimplePanel`]("StatusBar.SimplePanel.md")||
|[`SimpleText`]("StatusBar.SimpleText.md")||
|[`Size`]("Control.Size.md")|Returns/sets the height and width of the control (Windows, Linux, Android, Web).|
|[`SizeGrip`]("StatusBar.SizeGrip.md")||
...
|Name|Description|
| :------------ | :------------ |
|[`Add`]("StatusBar.Add.md")|Appends a new status panel to the bar|
...
|[`ChangePanelIndex`]("StatusBar.ChangePanelIndex.md")|Moves a panel to a new position in the collection|
...
|[`Clear`]("StatusBar.Clear.md")|Removes all status panels|
...
|[`IndexOf`]("StatusBar.IndexOf.md")|Returns the index of a specified panel|
...
|[`ReadProperty`]("StatusBar.ReadProperty.md")|Loads properties from persistence stream|
|[`RecreateWnd`]("Control.RecreateWnd.md")|Recreates the window (Windows only)|
|[`Remove`]("StatusBar.Remove.md")|Deletes a specific status panel|
...
|[`UpdatePanels`]("StatusBar.UpdatePanels.md")|Refreshes panel layout and appearance|
|[`UpdateUnLock`]("Control.UpdateUnLock.md")|Enables drawing in the specified window (Windows only).|
|[`WriteProperty`]("StatusBar.WriteProperty.md")|Saves properties to persistence stream|
## Events
|Name|Description|
| :------------ | :------------ |
...
|[`OnPanelClick`]("StatusBar.OnPanelClick.md") |Triggered when a status panel is clicked|
|[`OnPanelDblClick`]("StatusBar.OnPanelDblClick.md") |Raised when a status panel is double-clicked|
