...
|[`ArrowChangeSize`]("PageScroller.ArrowChangeSize.md")||
|[`AutoScroll`]("PageScroller.AutoScroll.md")||
...
|[`ChildDragDrop`]("PageScroller.ChildDragDrop.md")||
...
|[`Position`]("PageScroller.Position.md")||
...
|Name|Description|
| :------------ | :------------ |
|[`Add`]("PageScroller.Add.md")|Adds the specified control to the control collection (Windows, Linux).|
...
|[`ReadProperty`]("PageScroller.ReadProperty.md")||
...
|[`WriteProperty`]("PageScroller.WriteProperty.md")||
## Events
|Name|Description|
| :------------ | :------------ |
...
|[`OnScroll`]("PageScroller.OnScroll.md") ||
## Examples
```freeBasic
	\#ifdef __FB_WIN32__
	'\#Compile "Form1.rc"
