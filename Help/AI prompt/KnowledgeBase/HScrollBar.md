...
`HScrollBar` - `HScrollBar` is a Control within the MyFbFramework, part of the freeBasic framework. <br> `HScrollBar` - Provides a horizontal scroll bar for easy navigation through long lists of items.
...
|[`ArrowChangeSize`]("HScrollBar.ArrowChangeSize.md")||
...
|[`TabIndex`]("HScrollBar.TabIndex.md")||
|[`TabStop`]("HScrollBar.TabStop.md")||
...
|[`ReadProperty`]("HScrollBar.ReadProperty.md")|Loads scroll configuration from stream|
...
|[`WriteProperty`]("HScrollBar.WriteProperty.md")|Saves scroll configuration to stream|
## Events
|Name|Description|
| :------------ | :------------ |
...
|[`OnScroll`]("HScrollBar.OnScroll.md") |Triggered during thumb position changes|
## See also
Namespace: [`My.Sys.Forms`](My.Sys.Forms.md)
