...
|[`CreateWnd`]("ToolTips.CreateWnd.md")||
...
|[`Hide`]("ToolTips.Hide.md")|Conceals the ToolTip from the user (Windows only).|
...
|[`Show`]("ToolTips.Show.md")|Displays the ToolTip to the user (Windows only).|
...
|[`OnLinkClicked`]("ToolTips.OnLinkClicked.md") ||
