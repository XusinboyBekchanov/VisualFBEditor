...
`TreeListView` - `TreeListView` is a Control within the MyFbFramework, part of the freeBasic framework. <br> `TreeListView` - Combines the features of a `TreeView` and a `ListView`.
...
|[`ColumnHeaderHidden`]("TreeListView.ColumnHeaderHidden.md")||
|[`Columns`]("TreeListView.Columns.md")|Collection of column definitions.|
|[`ColumnTypes`]("TreeListView.ColumnTypes.md")|Specifies column data types (Text/Image/Checkbox).|
...
|[`EditLabels`]("TreeListView.EditLabels.md")||
...
|[`GridLines`]("TreeListView.GridLines.md")||
...
|[`Images`]("TreeListView.Images.md")|Image list for node icons.|
...
|[`MultiSelect`]("TreeListView.MultiSelect.md")||
|[`Name`]("Component.Name.md")|Returns the name used in code to identify an object (Windows, Linux, Android, Web).|
|[`Nodes`]("TreeListView.Nodes.md")|Root tree node collection.|
|[`OwnerData`]("TreeListView.OwnerData.md")||
|[`OwnerDraw`]("TreeListView.OwnerDraw.md")||
|[`Parent`]("Control.Parent.md")|Returns/sets the parent container of the control (Windows, Linux, Android, Web).|
|[`SelectedColumn`]("TreeListView.SelectedColumn.md")||
|[`SelectedItem`]("TreeListView.SelectedItem.md")||
|[`SelectedItemIndex`]("TreeListView.SelectedItemIndex.md")||
|[`ShowCaption`]("Control.ShowCaption.md")|Returns/sets the value indicating show Caption. (Windows only).|
|[`ShowHint`]("TreeListView.ShowHint.md")||
|[`SingleClickActivate`]("TreeListView.SingleClickActivate.md")||
|[`Size`]("Control.Size.md")|Returns/sets the height and width of the control (Windows, Linux, Android, Web).|
|[`Sort`]("TreeListView.Sort.md")||
|[`StateImages`]("TreeListView.StateImages.md")|Image list for node state icons.|
|[`SubClass`]("Control.SubClass.md")|Returs/sets a value indicating type is subclass or not (Windows only).|
|[`TabIndex`]("TreeListView.TabIndex.md")||
|[`TabStop`]("TreeListView.TabStop.md")||
...
|[`TreeSelection`]("TreeListView.TreeSelection.md")|Selection mode (Single/Multiple).|
|[`TreeStore`]("TreeListView.TreeStore.md")|Pointer to native tree storage structure.|
...
|[`CollapseAll`]("TreeListView.CollapseAll.md")|Collapses all expanded nodes.|
...
|[`EnsureVisible`]("TreeListView.EnsureVisible.md")|Scrolls to make node visible.|
|[`ExpandAll`]("TreeListView.ExpandAll.md")|Expands all collapsible nodes.|
...
|[`GetItemByVisibleIndex`]("TreeListView.GetItemByVisibleIndex.md")|Retrieves node by visual position.|
...
|[`Init`]("TreeListView.Init.md")|Initializes control components.|
...
|[`ReadProperty`]("TreeListView.ReadProperty.md")|Loads persisted properties.|
...
|[`WriteProperty`]("TreeListView.WriteProperty.md")|Saves properties to storage.|
## Events
|Name|Description|
| :------------ | :------------ |
|[`OnBeginScroll`]("TreeListView.OnBeginScroll.md") |Raised when scrolling starts.|
|[`OnCacheHint`]("TreeListView.OnCacheHint.md") |Virtual mode data prefetch notification.|
|[`OnCellEdited`]("TreeListView.OnCellEdited.md") |Triggered after cell edit completion.|
|[`OnCellEditing`]("TreeListView.OnCellEditing.md") |Triggered before cell editing starts.|
...
|[`OnDrawItem`]("TreeListView.OnDrawItem.md") |Custom node rendering event.|
...
|[`OnEndScroll`]("TreeListView.OnEndScroll.md") |Raised when scrolling completes.|
|[`OnGetDisplayInfo`]("TreeListView.OnGetDisplayInfo.md") |Virtual mode data request event.|
|[`OnGotFocus`]("Control.OnGotFocus.md") |Occurs when the control receives focus (Windows, Linux, Web).|
|[`OnItemActivate`]("TreeListView.OnItemActivate.md") |Triggered on node activation.|
|[`OnItemClick`]("TreeListView.OnItemClick.md") |Raised on node click.|
|[`OnItemDblClick`]("TreeListView.OnItemDblClick.md") |Raised on node double-click.|
|[`OnItemExpanding`]("TreeListView.OnItemExpanding.md") |Triggered before node expansion.|
|[`OnItemKeyDown`]("TreeListView.OnItemKeyDown.md") |Keyboard input on focused node.|
...
|[`OnMeasureItem`]("TreeListView.OnMeasureItem.md") |Custom node sizing event.|
...
|[`OnSelectedItemChanged`]("TreeListView.OnSelectedItemChanged.md") |Raised after selection changes.|
## See also
Namespace: [`My.Sys.Forms`](My.Sys.Forms.md)
