...
`PrintPreviewControl` - `PrintPreviewControl` is a Control within the MyFbFramework, part of the freeBasic framework. <br> `PrintPreviewControl` - Displays document pages with zoom/scroll capabilities and print layout visualization.
...
|[`CurrentPage`]("PrintPreviewControl.CurrentPage.md")||
...
|[`Document`]("PrintPreviewControl.Document.md")||
...
|[`Orientation`]("PrintPreviewControl.Orientation.md")||
|[`PageLength`]("PrintPreviewControl.PageLength.md")||
|[`PageSize`]("PrintPreviewControl.PageSize.md")||
|[`PageWidth`]("PrintPreviewControl.PageWidth.md")||
...
|[`TabIndex`]("PrintPreviewControl.TabIndex.md")||
|[`TabStop`]("PrintPreviewControl.TabStop.md")||
...
|[`Zoom`]("PrintPreviewControl.Zoom.md")||
...
|[`ReadProperty`]("PrintPreviewControl.ReadProperty.md")|Loads page settings from stream|
...
|[`WriteProperty`]("PrintPreviewControl.WriteProperty.md")|Saves page settings to stream|
## Events
|Name|Description|
| :------------ | :------------ |
...
|[`OnCurrentPageChanged`]("PrintPreviewControl.OnCurrentPageChanged.md") |Triggered when displayed page changes|
...
|[`OnScroll`]("PrintPreviewControl.OnScroll.md") |Raised during viewport scrolling|
|[`OnZoom`]("PrintPreviewControl.OnZoom.md") |Triggered when zoom level changes|
## See also
Namespace: [`My.Sys.Forms`](My.Sys.Forms.md)
