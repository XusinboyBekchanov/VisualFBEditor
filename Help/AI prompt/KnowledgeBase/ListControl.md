...
`ListControl` - `ListControl` is a Control within the MyFbFramework, part of the freeBasic framework. <br> `ListControl` - Displays a list of items from which the user can select one or more.
...
|[`AddItem`]("ListControl.AddItem.md")|Adds new item to the list|
...
|[`InsertItem`]("ListControl.InsertItem.md")|Inserts item at specified position|
...
|[`LoadFromFile`]("ListControl.LoadFromFile.md")|Loads items from text file|
|[`NewIndex`]("ListControl.NewIndex.md")|Gets index for newly added item|
|[`ProcessMessage`]("Control.ProcessMessage.md")||
|[`ReadProperty`]("ListControl.ReadProperty.md")|Loads persisted properties|
...
|[`SaveToFile`]("ListControl.SaveToFile.md")|Saves items to text file|
...
|[`WriteProperty`]("ListControl.WriteProperty.md")|Persists properties to storage|
## Events
|Name|Description|
| :------------ | :------------ |
